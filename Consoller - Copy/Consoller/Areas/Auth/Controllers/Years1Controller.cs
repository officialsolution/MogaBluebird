...
{
    public class Years1Controller : Controller
    {
        ...
        // GET: Auth/Years1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Auth/Years1/Create
