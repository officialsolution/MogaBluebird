...
namespace Consoller.Areas.Auth.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        // GET: Auth/Categories/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Auth/Categories/Create
